!(function (e, t) {
    ...
    "object" == typeof exports && "object" == typeof module
        ? (module.exports = !bNode ? t() : t(require("worker_threads"), require("https"), require("http"), require("fs"), require("os")))
        : "function" == typeof define && define.amd
        ? define(t)
        : "object" == typeof exports
        ? (exports.dbr = !bNode ? t() : t(require("worker_threads"), require("https"), require("http"), require("fs"), require("os")))
        : (e.dbr = t(e.worker_threads, e.https, e.http, e.fs, e.os));
    ...
    return (function (e) {
                        ...
                        function (e, t, n) {
                            ...
                            function I(e, t) {
                                return new s(function (n, r) {
                                    if (((_[e.name] = _[e.name] || { forages: [], db: null, dbReady: null, deferredOperations: [] }), e.db)) {
                                        if (!t) return n(e.db);
                                        g(e), e.db.close();
                                    }
                                    var o = [e.name];
                            ...
                            var D = {
                                    ...
                                    _initStorage: function (e) {
                                        ...
                                        var i = _[n.name];
                                        i || ((i = { forages: [], db: null, dbReady: null, deferredOperations: [] }), (_[n.name] = i)), i.forages.push(t), t._initReady || ((t._initReady = t.ready), (t.ready = S));
                                        var o = [];
                                        function a() {
                                            return s.resolve();
                                        }
                                    ...
                                    iterate: function (e, t) {
                                        var n = this,
                                            r = new s(function (t, r) {
                                                n.ready()
                                                    .then(function () {
                                                        T(n._dbInfo, "readonly", function (i, o) {
                                                            if (i) return r(i);
                                                            try {
                                    ...
                                    setItem: function (e, t, n) {
                                        ...
                                        var i = new s(function (n, i) {
                                            ...
                                            r.ready()
                                                ...
                                                .then(function (t) {
                                                    T(r._dbInfo, "readwrite", function (o, s) {
                                                        if (o) return i(o);
                                                        try {
                                    ...
                                    removeItem: function (e, t) {
                                        ...
                                        var r = new s(function (t, r) {
                                            n.ready()
                                                .then(function () {
                                                    T(n._dbInfo, "readwrite", function (i, o) {
                                                        if (i) return r(i);
                                                        try {
                                    ...
                                    clear: function (e) {
                                        var t = this,
                                            n = new s(function (e, n) {
                                                t.ready()
                                                    .then(function () {
                                                        T(t._dbInfo, "readwrite", function (r, i) {
                                                            if (r) return n(r);
                                                            try {
                                    ...
                                    length: function (e) {
                                        var t = this,
                                            n = new s(function (e, n) {
                                                t.ready()
                                                    .then(function () {
                                                        T(t._dbInfo, "readonly", function (r, i) {
                                                            if (r) return n(r);
                                                            try {
                                                    ...
                                                    : d.db.transaction(
                                                          function (n) {
                                                              F(
                                                                  n,
                                                                  d,
                                                                  "INSERT OR REPLACE INTO " + d.storeName + " (key, value) VALUES (?, ?)",
                                                                  [e, t],
                                                                  function () {
                                                                      o(a);
                                                                  },
                                                          ...
                                                          function (t) {
                                                              if (t.code === t.QUOTA_ERR) {
                                                                  if (r > 0) return void o(k.apply(i, [e, a, n, r - 1]));
                                                                  s(t);
                                                              }
                                                          }
                                                      );
                                    ...
                                    return (
                                        a(
                                            (r = e.name
                                                ? new s(function (t) {
                                                      var r;
                                                      (r = e.name === n.name ? i._dbInfo.db : openDatabase(e.name, "", "", 0)), e.storeName ? t({ db: r, storeNames: [e.storeName] }) : t(U(r));
                                                  }).then(function (e) {
                                                      return new s(function (t, n) {
                                                          e.db.transaction(
                                                              function (r) {
                            ...
                            var W = {
                                    ...
                                    _initStorage: function (e) {
                                        ...
                                        return (t.keyPrefix = x(e, this._defaultConfig)), G() ? ((this._dbInfo = t), (t.serializer = w), s.resolve()) : s.reject();
                                    },
                                    _support: (function () {
                                        try {
                                ...
                                K = {},
                                J = {},
                                Y = { INDEXEDDB: D, WEBSQL: V, LOCALSTORAGE: W },
                                ...
                                Z = { description: "", driver: X.slice(), name: "localforage", size: 4980736, storeName: "keyvaluepairs", version: 1 };
                            function q(e, t) {
                                e[t] = function () {
                                    var n = arguments;
                            ...
                            function $() {
                                for (var e = 1; e < arguments.length; e++) {
                                    var t = arguments[e];
                                    if (t) for (var n in t) t.hasOwnProperty(n) && (H(t[n]) ? (arguments[0][n] = t[n].slice()) : (arguments[0][n] = t[n]));
                                }
                                return arguments[0];
                            }
                            var ee = new ((function () {
        ...
        function (e, t, n) {
            ...
            n.r(t),
                ...
                (function (e) {
                    (e[(e.IPF_Binary = 0)] = "IPF_Binary"),
                        (e[(e.IPF_BinaryInverted = 1)] = "IPF_BinaryInverted"),
                        (e[(e.IPF_GrayScaled = 2)] = "IPF_GrayScaled"),
                        (e[(e.IPF_NV21 = 3)] = "IPF_NV21"),
                        (e[(e.IPF_RGB_565 = 4)] = "IPF_RGB_565"),
                        (e[(e.IPF_RGB_555 = 5)] = "IPF_RGB_555"),
                        (e[(e.IPF_RGB_888 = 6)] = "IPF_RGB_888"),
                        (e[(e.IPF_ARGB_8888 = 7)] = "IPF_ARGB_8888"),
                        (e[(e.IPF_RGB_161616 = 8)] = "IPF_RGB_161616"),
                        (e[(e.IPF_ARGB_16161616 = 9)] = "IPF_ARGB_16161616"),
                        (e[(e.IPF_ABGR_8888 = 10)] = "IPF_ABGR_8888"),
                        (e[(e.IPF_ABGR_16161616 = 11)] = "IPF_ABGR_16161616"),
                        (e[(e.IPF_BGR_888 = 12)] = "IPF_BGR_888");
                })(r || (r = {})),
                (function (e) {
                    (e[(e.DBR_SYSTEM_EXCEPTION = 1)] = "DBR_SYSTEM_EXCEPTION"),
                        (e[(e.DBR_SUCCESS = 0)] = "DBR_SUCCESS"),
                        (e[(e.DBR_UNKNOWN = -1e4)] = "DBR_UNKNOWN"),
                        (e[(e.DBR_NO_MEMORY = -10001)] = "DBR_NO_MEMORY"),
                        (e[(e.DBR_NULL_REFERENCE = -10002)] = "DBR_NULL_REFERENCE"),
                        (e[(e.DBR_LICENSE_INVALID = -10003)] = "DBR_LICENSE_INVALID"),
                        (e[(e.DBR_LICENSE_EXPIRED = -10004)] = "DBR_LICENSE_EXPIRED"),
                        (e[(e.DBR_FILE_NOT_FOUND = -10005)] = "DBR_FILE_NOT_FOUND"),
                        (e[(e.DBR_FILETYPE_NOT_SUPPORTED = -10006)] = "DBR_FILETYPE_NOT_SUPPORTED"),
                        (e[(e.DBR_BPP_NOT_SUPPORTED = -10007)] = "DBR_BPP_NOT_SUPPORTED"),
                        (e[(e.DBR_INDEX_INVALID = -10008)] = "DBR_INDEX_INVALID"),
                        (e[(e.DBR_BARCODE_FORMAT_INVALID = -10009)] = "DBR_BARCODE_FORMAT_INVALID"),
                        (e[(e.DBR_CUSTOM_REGION_INVALID = -10010)] = "DBR_CUSTOM_REGION_INVALID"),
                        (e[(e.DBR_MAX_BARCODE_NUMBER_INVALID = -10011)] = "DBR_MAX_BARCODE_NUMBER_INVALID"),
                        (e[(e.DBR_IMAGE_READ_FAILED = -10012)] = "DBR_IMAGE_READ_FAILED"),
                        (e[(e.DBR_TIFF_READ_FAILED = -10013)] = "DBR_TIFF_READ_FAILED"),
                        (e[(e.DBR_QR_LICENSE_INVALID = -10016)] = "DBR_QR_LICENSE_INVALID"),
                        (e[(e.DBR_1D_LICENSE_INVALID = -10017)] = "DBR_1D_LICENSE_INVALID"),
                        (e[(e.DBR_DIB_BUFFER_INVALID = -10018)] = "DBR_DIB_BUFFER_INVALID"),
                        (e[(e.DBR_PDF417_LICENSE_INVALID = -10019)] = "DBR_PDF417_LICENSE_INVALID"),
                        (e[(e.DBR_DATAMATRIX_LICENSE_INVALID = -10020)] = "DBR_DATAMATRIX_LICENSE_INVALID"),
                        (e[(e.DBR_PDF_READ_FAILED = -10021)] = "DBR_PDF_READ_FAILED"),
                        (e[(e.DBR_PDF_DLL_MISSING = -10022)] = "DBR_PDF_DLL_MISSING"),
                        (e[(e.DBR_PAGE_NUMBER_INVALID = -10023)] = "DBR_PAGE_NUMBER_INVALID"),
                        (e[(e.DBR_CUSTOM_SIZE_INVALID = -10024)] = "DBR_CUSTOM_SIZE_INVALID"),
                        (e[(e.DBR_CUSTOM_MODULESIZE_INVALID = -10025)] = "DBR_CUSTOM_MODULESIZE_INVALID"),
                        (e[(e.DBR_RECOGNITION_TIMEOUT = -10026)] = "DBR_RECOGNITION_TIMEOUT"),
                        (e[(e.DBR_JSON_PARSE_FAILED = -10030)] = "DBR_JSON_PARSE_FAILED"),
                        (e[(e.DBR_JSON_TYPE_INVALID = -10031)] = "DBR_JSON_TYPE_INVALID"),
                        (e[(e.DBR_JSON_KEY_INVALID = -10032)] = "DBR_JSON_KEY_INVALID"),
                        (e[(e.DBR_JSON_VALUE_INVALID = -10033)] = "DBR_JSON_VALUE_INVALID"),
                        (e[(e.DBR_JSON_NAME_KEY_MISSING = -10034)] = "DBR_JSON_NAME_KEY_MISSING"),
                        (e[(e.DBR_JSON_NAME_VALUE_DUPLICATED = -10035)] = "DBR_JSON_NAME_VALUE_DUPLICATED"),
                        (e[(e.DBR_TEMPLATE_NAME_INVALID = -10036)] = "DBR_TEMPLATE_NAME_INVALID"),
                        (e[(e.DBR_JSON_NAME_REFERENCE_INVALID = -10037)] = "DBR_JSON_NAME_REFERENCE_INVALID"),
                        (e[(e.DBR_PARAMETER_VALUE_INVALID = -10038)] = "DBR_PARAMETER_VALUE_INVALID"),
                        (e[(e.DBR_DOMAIN_NOT_MATCHED = -10039)] = "DBR_DOMAIN_NOT_MATCHED"),
                        (e[(e.DBR_RESERVEDINFO_NOT_MATCHED = -10040)] = "DBR_RESERVEDINFO_NOT_MATCHED"),
                        (e[(e.DBR_AZTEC_LICENSE_INVALID = -10041)] = "DBR_AZTEC_LICENSE_INVALID"),
                        (e[(e.DBR_LICENSE_DLL_MISSING = -10042)] = "DBR_LICENSE_DLL_MISSING"),
                        (e[(e.DBR_LICENSEKEY_NOT_MATCHED = -10043)] = "DBR_LICENSEKEY_NOT_MATCHED"),
                        (e[(e.DBR_REQUESTED_FAILED = -10044)] = "DBR_REQUESTED_FAILED"),
                        (e[(e.DBR_LICENSE_INIT_FAILED = -10045)] = "DBR_LICENSE_INIT_FAILED"),
                        (e[(e.DBR_PATCHCODE_LICENSE_INVALID = -10046)] = "DBR_PATCHCODE_LICENSE_INVALID"),
                        (e[(e.DBR_POSTALCODE_LICENSE_INVALID = -10047)] = "DBR_POSTALCODE_LICENSE_INVALID"),
                        (e[(e.DBR_DPM_LICENSE_INVALID = -10048)] = "DBR_DPM_LICENSE_INVALID"),
                        (e[(e.DBR_FRAME_DECODING_THREAD_EXISTS = -10049)] = "DBR_FRAME_DECODING_THREAD_EXISTS"),
                        (e[(e.DBR_STOP_DECODING_THREAD_FAILED = -10050)] = "DBR_STOP_DECODING_THREAD_FAILED"),
                        (e[(e.DBR_SET_MODE_ARGUMENT_ERROR = -10051)] = "DBR_SET_MODE_ARGUMENT_ERROR"),
                        (e[(e.DBR_LICENSE_CONTENT_INVALID = -10052)] = "DBR_LICENSE_CONTENT_INVALID"),
                        (e[(e.DBR_LICENSE_KEY_INVALID = -10053)] = "DBR_LICENSE_KEY_INVALID"),
                        (e[(e.DBR_LICENSE_DEVICE_RUNS_OUT = -10054)] = "DBR_LICENSE_DEVICE_RUNS_OUT"),
                        (e[(e.DBR_GET_MODE_ARGUMENT_ERROR = -10055)] = "DBR_GET_MODE_ARGUMENT_ERROR"),
                        (e[(e.DBR_IRT_LICENSE_INVALID = -10056)] = "DBR_IRT_LICENSE_INVALID"),
                        (e[(e.DBR_MAXICODE_LICENSE_INVALID = -10057)] = "DBR_MAXICODE_LICENSE_INVALID"),
                        (e[(e.DBR_GS1_DATABAR_LICENSE_INVALID = -10058)] = "DBR_GS1_DATABAR_LICENSE_INVALID"),
                        (e[(e.DBR_GS1_COMPOSITE_LICENSE_INVALID = -10059)] = "DBR_GS1_COMPOSITE_LICENSE_INVALID"),
                        (e[(e.DBR_DOTCODE_LICENSE_INVALID = -10061)] = "DBR_DOTCODE_LICENSE_INVALID");
                })(i || (i = {})),
                (function (e) {
                    (e[(e.IMRDT_IMAGE = 1)] = "IMRDT_IMAGE"),
                        (e[(e.IMRDT_CONTOUR = 2)] = "IMRDT_CONTOUR"),
                        (e[(e.IMRDT_LINESEGMENT = 4)] = "IMRDT_LINESEGMENT"),
                        (e[(e.IMRDT_LOCALIZATIONRESULT = 8)] = "IMRDT_LOCALIZATIONRESULT"),
                        (e[(e.IMRDT_REGIONOFINTEREST = 16)] = "IMRDT_REGIONOFINTEREST"),
                        (e[(e.IMRDT_QUADRILATERAL = 32)] = "IMRDT_QUADRILATERAL");
                })(o || (o = {})),
                (function (e) {
                    (e[(e.BF_ALL = -32505857)] = "BF_ALL"),
                        (e[(e.BF_ONED = 2047)] = "BF_ONED"),
                        (e[(e.BF_GS1_DATABAR = 260096)] = "BF_GS1_DATABAR"),
                        (e[(e.BF_CODE_39 = 1)] = "BF_CODE_39"),
                        (e[(e.BF_CODE_128 = 2)] = "BF_CODE_128"),
                        (e[(e.BF_CODE_93 = 4)] = "BF_CODE_93"),
                        (e[(e.BF_CODABAR = 8)] = "BF_CODABAR"),
                        (e[(e.BF_ITF = 16)] = "BF_ITF"),
                        (e[(e.BF_EAN_13 = 32)] = "BF_EAN_13"),
                        (e[(e.BF_EAN_8 = 64)] = "BF_EAN_8"),
                        (e[(e.BF_UPC_A = 128)] = "BF_UPC_A"),
                        (e[(e.BF_UPC_E = 256)] = "BF_UPC_E"),
                        (e[(e.BF_INDUSTRIAL_25 = 512)] = "BF_INDUSTRIAL_25"),
                        (e[(e.BF_CODE_39_EXTENDED = 1024)] = "BF_CODE_39_EXTENDED"),
                        (e[(e.BF_GS1_DATABAR_OMNIDIRECTIONAL = 2048)] = "BF_GS1_DATABAR_OMNIDIRECTIONAL"),
                        (e[(e.BF_GS1_DATABAR_TRUNCATED = 4096)] = "BF_GS1_DATABAR_TRUNCATED"),
                        (e[(e.BF_GS1_DATABAR_STACKED = 8192)] = "BF_GS1_DATABAR_STACKED"),
                        (e[(e.BF_GS1_DATABAR_STACKED_OMNIDIRECTIONAL = 16384)] = "BF_GS1_DATABAR_STACKED_OMNIDIRECTIONAL"),
                        (e[(e.BF_GS1_DATABAR_EXPANDED = 32768)] = "BF_GS1_DATABAR_EXPANDED"),
                        (e[(e.BF_GS1_DATABAR_EXPANDED_STACKED = 65536)] = "BF_GS1_DATABAR_EXPANDED_STACKED"),
                        (e[(e.BF_GS1_DATABAR_LIMITED = 131072)] = "BF_GS1_DATABAR_LIMITED"),
                        (e[(e.BF_PATCHCODE = 262144)] = "BF_PATCHCODE"),
                        (e[(e.BF_PDF417 = 33554432)] = "BF_PDF417"),
                        (e[(e.BF_QR_CODE = 67108864)] = "BF_QR_CODE"),
                        (e[(e.BF_DATAMATRIX = 134217728)] = "BF_DATAMATRIX"),
                        (e[(e.BF_AZTEC = 268435456)] = "BF_AZTEC"),
                        (e[(e.BF_MAXICODE = 536870912)] = "BF_MAXICODE"),
                        (e[(e.BF_MICRO_QR = 1073741824)] = "BF_MICRO_QR"),
                        (e[(e.BF_MICRO_PDF417 = 524288)] = "BF_MICRO_PDF417"),
                        (e[(e.BF_GS1_COMPOSITE = -2147483648)] = "BF_GS1_COMPOSITE"),
                        (e[(e.BF_NULL = 0)] = "BF_NULL");
                })(s || (s = {}));
            ...
            class c {
                constructor() {
                    (this._canvasMaxWH = "iPhone" == c.browserInfo.OS || "Android" == c.browserInfo.OS ? 2048 : 4096),
                        (this._instanceID = void 0),
                        (this.bSaveOriCanvas = !1),
                        (this.oriCanvas = null),
                        (this.maxVideoCvsLength = 3),
                        (this.videoCvses = []),
                        (this.videoGlCvs = null),
                        (this.videoGlCtx = null),
                ...
                static set sessionPwd(e) {
                    if ("unload" != this._loadWasmStatus) throw new Error("`sessionPwd` is not allowed to change after loadWasm is called.");
                    this._sessionPwd = e;
                }
                static get sessionPwd() {
                    return this._sessionPwd;
                }
                static detectEnvironment() {
                    return a(this, void 0, void 0, function* () {
                        ...
                        if (e.getUserMedia)
                            try {
                                (yield navigator.mediaDevices.getUserMedia({ video: !0 })).getTracks().forEach((e) => {
                                    e.stop();
                                }),
                                    (e.camera = !0);
                            } catch (e) {}
                ...
                static loadWasm() {
                    return a(this, void 0, void 0, function* () {
                        ...
                        let e =
                            8 == this.productKeys.length || (this.productKeys.length > 8 && !this.productKeys.startsWith("t") && !this.productKeys.startsWith("f") && !this.productKeys.startsWith("P") && !this.productKeys.startsWith("L"));
                        return e && self.crypto && !self.crypto.subtle
                            ? Promise.reject("Need https to use handshake code in this browser.")
                                          ...
                                          case "unload": {
                                              ...
                                              let e = new Map(),
                                                  t = (t, n, r) =>
                                                      a(this, void 0, void 0, function* () {
                                                          let i = e.get(t);
                                                          return i || ((i = yield d.createInstance({ name: t })), e.set(t, i)), yield i[n].apply(i, r);
                                                      }),
                                                  r = this.engineResourcePath + this._workerName;
                                              if (
                                                  (l ||
                                                      this.engineResourcePath.startsWith(location.origin) ||
                                                      (r = yield fetch(r)
                                                          .then((e) => e.blob())
                                              ...
                                              let i,
                                                  o = (e) => atob(String.fromCharCode.apply(null, e).replaceAll("\n", "+").replaceAll(" ", "=")),
                                                  ...
                                                  u = (e, t) =>
                                                      a(this, void 0, void 0, function* () {
                                                          ...
                                                          i || (i = yield s(t));
                                                          let l = yield self[o(t.c)][o(t.e)][o(t.i)]({ name: o(t.g), [o(t.j)]: a, [o(t.l)]: 128 }, i, d);
                                              ...
                                              (this._dbrWorker.onmessage = (e) =>
                                                  a(this, void 0, void 0, function* () {
                                                      ...
                                                      switch (n.type) {
                                                          ...
                                                          case "load":
                                                              if (n.success) {
                                                                  (c._loadWasmStatus = "loadSuccess"),
                                                                      (c._version = n.version + "(JS " + this._jsVersion + "." + this._jsEditVersion + ")"),
                                                                      this._onLog && this._onLog("load dbr worker success");
                                                          ...
                                                          case "taskd": {
                                                              ...
                                                              this._dbrWorker.postMessage({ type: "task", id: n.taskID, body: { success: !0, txt: e } });
                                                              break;
                                                          }
                                                          case "taske": {
                                                          ...
                                                          case "localforage": {
                                                              ...
                                                              this._dbrWorker.postMessage({ type: "task", id: n.taskID, body: { success: !0, result: e } });
                                                              break;
                                                          }
                                                          default:
                                                  ...
                                                  l && this._dbrWorker.on("message", this._dbrWorker.onmessage),
                        ...
                        return (
                            ...
                            yield new Promise((t, n) => {
                                ...
                                this._taskCallbackMap.set(r, (e) => {
                                    ...
                                    this._dbrWorker.postMessage({ type: "createInstance", id: r, productKeys: "", bScanner: e });
                            })
                        );
                    });
                }
                    ...
                    return a(this, void 0, void 0, function* () {
                        if ((c._onLog && c._onLog("decode(source: any)"), c._onLog && (this._timeStartDecode = Date.now()), l))
                            return e instanceof Buffer
                                ? yield this._decodeFileInMemory_Uint8Array(new Uint8Array(e))
                                : e instanceof Uint8Array
                                ? yield this._decodeFileInMemory_Uint8Array(e)
                                : "string" == typeof e || e instanceof String
                                ? "data:image/" == e.substring(0, 11)
                                    ? yield this._decode_Base64(e)
                                    : "http" == e.substring(0, 4)
                                    ? yield this._decode_Url(e)
                                    : yield this._decode_FilePath(e)
                                : yield Promise.reject(TypeError("'_decode(source, config)': Type of 'source' should be 'Buffer', 'Uint8Array', 'String(base64 with image mime)' or 'String(url)'."));
                        {
                            let t = {};
                            return (
                                !this.region || this.region instanceof Array || (t.region = JSON.parse(JSON.stringify(this.region))),
                                e instanceof Blob
                                    ? yield this._decode_Blob(e, t)
                                    : e instanceof ArrayBuffer
                                    ? yield this._decode_ArrayBuffer(e, t)
                                    : e instanceof Uint8Array || e instanceof Uint8ClampedArray
                                    ? yield this._decode_Uint8Array(e, t)
                                    : e instanceof HTMLImageElement || ("undefined" != typeof ImageBitmap && e instanceof ImageBitmap)
                                    ? yield this._decode_Image(e, t)
                                    : e instanceof HTMLCanvasElement || ("undefined" != typeof OffscreenCanvas && e instanceof OffscreenCanvas)
                                    ? yield this._decode_Canvas(e, t)
                                    : e instanceof HTMLVideoElement
                                    ? yield this._decode_Video(e, t)
                                    : "string" == typeof e || e instanceof String
                                    ? "data:image/" == e.substring(0, 11)
                                        ? yield this._decode_Base64(e, t)
                                        : yield this._decode_Url(e, t)
                                    : yield Promise.reject(
                                          TypeError(
                                              "'_decode(source, config)': Type of 'source' should be 'Blob', 'ArrayBuffer', 'Uint8Array', 'HTMLImageElement', 'HTMLCanvasElement', 'HTMLVideoElement', 'String(base64 with image mime)' or 'String(url)'."
                                          )
                                      )
                            );
                        }
                        ...
                        return yield new Promise((s, a) => {
                            ...
                            c._taskCallbackMap.set(d, (e) => {
                                if (e.success) {
                                    ...
                                    if (c._onLog) {
                                        let e = Date.now();
                                        c._onLog("DBR time get result: " + n),
                                            c._onLog("Handle image cost: " + (this._timeEnterInnerDBR - this._timeStartDecode)),
                                            c._onLog("DBR worker decode image cost: " + (n - this._timeEnterInnerDBR)),
                                            c._onLog("DBR worker handle results: " + (e - n)),
                                            c._onLog("Total decode image cost: " + (e - this._timeStartDecode));
                                    }
                                    return s(t);
                                }
                                {
                                ...
                                c._onLog && (this._timeEnterInnerDBR = Date.now()),
                                c._onLog && c._onLog("Send buffer to worker:" + Date.now()),
                                c._dbrWorker.postMessage({ type: "decodeBuffer", id: d, instanceID: this._instanceID, body: { buffer: e, width: t, height: n, stride: r, format: i, config: o } }, [e.buffer]);
                        });
                    });
                }
                ...
                decodeBuffer(e, t, n, r, i, o) {
                    return a(this, void 0, void 0, function* () {
                        ...
                        return (
                            ...
                            l
                                ? e instanceof Uint8Array
                                    ? (s = yield this._decodeBuffer_Uint8Array(e, t, n, r, i, o))
                                    : e instanceof Buffer && (s = yield this._decodeBuffer_Uint8Array(new Uint8Array(e), t, n, r, i, o))
                                : e instanceof Uint8Array || e instanceof Uint8ClampedArray
                                ? (s = yield this._decodeBuffer_Uint8Array(e, t, n, r, i, o))
                                : e instanceof ArrayBuffer
                                ? (s = yield this._decodeBuffer_Uint8Array(new Uint8Array(e), t, n, r, i, o))
                                : e instanceof Blob && (s = yield this._decodeBuffer_Blob(e, t, n, r, i, o)),
                            s
                        );
                    });
                }
                    ...
                    return a(this, void 0, void 0, function* () {
                        return yield new Promise((t, n) => {
                            ...
                            c._taskCallbackMap.set(r, (e) => {
                                ...
                                c._dbrWorker.postMessage({ type: "decodeFileInMemory", id: r, instanceID: this._instanceID, body: { bytes: e } });
                        });
                    });
                }
                getRuntimeSettings() {
                    return a(this, void 0, void 0, function* () {
                        return yield new Promise((e, t) => {
                            ...
                            c._taskCallbackMap.set(n, (n) => {
                                ...
                                c._dbrWorker.postMessage({ type: "getRuntimeSettings", id: n, instanceID: this._instanceID });
                        });
                    });
                }
                    ...
                    return a(this, void 0, void 0, function* () {
                        ...
                        if ("string" == typeof e || ("object" == typeof e && e instanceof String))
                            if ("speed" == e) {
                                ...
                                yield this.resetRuntimeSettings(),
                                    (t = yield this.getRuntimeSettings()),
                                    (t.barcodeFormatIds = e.barcodeFormatIds),
                                    (t.barcodeFormatIds_2 = e.barcodeFormatIds_2),
                                    (t.region = e.region),
                                    (t.deblurLevel = 3),
                            ...
                            if (((t = JSON.parse(JSON.stringify(e))), t.region instanceof Array)) {
                                let e = t.region;
                                [e.regionLeft, e.regionTop, e.regionLeft, e.regionBottom, e.regionMeasuredByPercentage].some((e) => void 0 !== e) &&
                                    (t.region = {
                        ...
                        if (!l)
                            if (this.bFilterRegionInJs) {
                                ...
                                (this.userDefinedRegion = JSON.parse(JSON.stringify(e))),
                                    (e.regionLeft || e.regionTop || e.regionRight || e.regionBottom || e.regionMeasuredByPercentage) &&
                                    (e.regionLeft || e.regionTop || 100 != e.regionRight || 100 != e.regionBottom || !e.regionMeasuredByPercentage)
                                        ? (this.region = e)
                                        : (this.region = null),
                                    (t.region = { regionLeft: 0, regionTop: 0, regionRight: 0, regionBottom: 0, regionMeasuredByPercentage: 0 });
                        ...
                        return yield new Promise((e, n) => {
                            ...
                            c._taskCallbackMap.set(r, (t) => {
                                ...
                                c._dbrWorker.postMessage({ type: "updateRuntimeSettings", id: r, instanceID: this._instanceID, body: { settings: JSON.stringify(t) } });
                        });
                    });
                }
                        ...
                        return (
                            ...
                            yield new Promise((e, t) => {
                                ...
                                c._taskCallbackMap.set(n, (n) => {
                                    ...
                                    c._dbrWorker.postMessage({ type: "resetRuntimeSettings", id: n, instanceID: this._instanceID });
                            })
                        );
                    });
                }
                    ...
                    return a(this, void 0, void 0, function* () {
                        ...
                        return yield new Promise((e, t) => {
                            ...
                            c._taskCallbackMap.set(n, (n) => {
                                ...
                                c._dbrWorker.postMessage({ type: "outputSettingsToString", id: n, instanceID: this._instanceID });
                        });
                    });
                }
                    ...
                    return a(this, void 0, void 0, function* () {
                        ...
                        return yield new Promise((t, n) => {
                            ...
                            c._taskCallbackMap.set(r, (e) => {
                                ...
                                c._dbrWorker.postMessage({ type: "initRuntimeSettingsWithString", id: r, instanceID: this._instanceID, body: { settings: e } });
                        });
                    });
                }
                _decode_Blob(e, t) {
                ...
                _decode_Image(e, t) {
                    return a(this, void 0, void 0, function* () {
                        ...
                        let n,
                            r,
                            i = e instanceof HTMLImageElement ? e.naturalWidth : e.width,
                        ...
                        if (g) {
                            let e, t, s, a;
                            g.regionMeasuredByPercentage
                                ? ((e = (g.regionLeft * n) / 100), (t = (g.regionTop * r) / 100), (s = (g.regionRight * n) / 100), (a = (g.regionBottom * r) / 100))
                                : ((e = g.regionLeft), (t = g.regionTop), (s = g.regionRight), (a = g.regionBottom)),
                                (h = s - e),
                                (u = Math.round((h / n) * i)),
                                (f = a - t),
                                (_ = Math.round((f / r) * o)),
                        ...
                        let E,
                            R = a.getContext("2d");
                        0 == d && 0 == l && i == u && o == _ && i == h && o == f ? R.drawImage(e, 0, 0) : R.drawImage(e, d, l, u, _, 0, 0, h, f),
                            e.dbrObjUrl && URL.revokeObjectURL(e.dbrObjUrl),
                            g ? ((E = JSON.parse(JSON.stringify(t))), delete E.region) : (E = t);
                        let I = yield this._decode_Canvas(a, E);
                        if (g && I.length > 0)
                            for (let e of I) {
                                let t = e.localizationResult;
                                2 == t.resultCoordinateType && ((t.x1 *= 0.01 * h), (t.x2 *= 0.01 * h), (t.x3 *= 0.01 * h), (t.x4 *= 0.01 * h), (t.y1 *= 0.01 * f), (t.y2 *= 0.01 * f), (t.y3 *= 0.01 * f), (t.y4 *= 0.01 * f)),
                                    (t.x1 += d),
                                    (t.x2 += d),
                                    (t.x3 += d),
                                    (t.x4 += d),
                                    ...
                                    (t.y3 += l),
                                    (t.y4 += l),
                                    2 == t.resultCoordinateType && ((t.x1 *= 100 / u), (t.x2 *= 100 / u), (t.x3 *= 100 / u), (t.x4 *= 100 / u), (t.y1 *= 100 / _), (t.y2 *= 100 / _), (t.y3 *= 100 / _), (t.y4 *= 100 / _));
                            }
                        return I;
                    });
                }
                ...
                _decode_Video(e, t) {
                    return a(this, void 0, void 0, function* () {
                        ...
                        if (g) {
                            let e, t, r, a;
                            g.regionMeasuredByPercentage
                                ? ((e = (g.regionLeft * n) / 100), (t = (g.regionTop * i) / 100), (r = (g.regionRight * n) / 100), (a = (g.regionBottom * i) / 100))
                                : ((e = g.regionLeft), (t = g.regionTop), (r = g.regionRight), (a = g.regionBottom)),
                                (h = r - e),
                                (u = Math.round((h / n) * o)),
                                (f = a - t),
                                (_ = Math.round((f / i) * s)),
                        ...
                        if (!this.bSaveOriCanvas && this._bUseWebgl && E) {
                            let t = !1;
                            this.videoGlCvs || ((this.videoGlCvs = self.OffscreenCanvas ? new OffscreenCanvas(h, f) : document.createElement("canvas")), (t = !0));
                            const n = this.videoGlCvs;
                            (n.width == h && n.height == f) || ((n.height = f), (n.width = h), (t = !0)),
                                this.videoGlCtx || ((this.videoGlCtx = n.getContext("webgl", { alpha: !1, antialias: !1 }) || n.getContext("experimental-webgl", { alpha: !1, antialias: !1 })), (t = !0));
                            const i = this.videoGlCtx;
                            if (t) {
                            ...
                            let o = new Uint8Array(h * f * 4);
                            return i.readPixels(0, 0, i.drawingBufferWidth, i.drawingBufferHeight, i.RGBA, i.UNSIGNED_BYTE, o), yield this._decodeBuffer_Uint8Array(o, h, f, 4 * h, r.IPF_ABGR_8888);
                        }
                        {
                            let n = null;
                            ...
                            n ||
                                (self.OffscreenCanvas ? (n = new OffscreenCanvas(h, f)) : ((n = document.createElement("canvas")), (n.width = h), (n.height = f)),
                                (n.dbrCtx2d = n.getContext("2d")),
                                this.videoCvses.length >= this.maxVideoCvsLength && (this.videoCvses = this.videoCvses.slice(1)),
                                this.videoCvses.push(n));
                            const r = n.dbrCtx2d;
                            let i;
                ...
                _handleRetJsonString(e) {
                    let t = i;
                    if (e.textResults) {
                        for (let n = 0; n < e.textResults.length; n++) {
                            let r = e.textResults[n];
                            e.exception != t.DBR_SUCCESS && (r.exception = e.exception);
                        }
                    ...
                    return a(this, void 0, void 0, function* () {
                        return yield new Promise((i, o) => {
                            ...
                            c._taskCallbackMap.set(s, (e) => {
                                ...
                                c._dbrWorker.postMessage({ type: "setModeArgument", id: s, instanceID: this._instanceID, body: { modeName: e, index: t, argumentName: n, argumentValue: r } });
                        });
                    });
                }
                    ...
                    return a(this, void 0, void 0, function* () {
                        return yield new Promise((r, i) => {
                            ...
                            c._taskCallbackMap.set(o, (e) => {
                                ...
                                c._dbrWorker.postMessage({ type: "getModeArgument", id: o, instanceID: this._instanceID, body: { modeName: e, index: t, argumentName: n } });
                        });
                    });
                }
                    ...
                    return a(this, void 0, void 0, function* () {
                        return yield new Promise((e, t) => {
                            ...
                            c._taskCallbackMap.set(n, (n) => {
                                ...
                                c._dbrWorker.postMessage({ type: "getIntermediateResults", id: n, instanceID: this._instanceID });
                        });
                    });
                }
                    ...
                    return (
                        ...
                        new Promise((e, t) => {
                            ...
                            c._taskCallbackMap.set(n, (n) => {
                                ...
                                c._dbrWorker.postMessage({ type: "destroy", id: n, instanceID: this._instanceID });
                        })
                    );
                }
            }
            (c.bNode = l),
                (c._jsVersion = "8.0.0"),
                (c._jsEditVersion = "20201113"),
                (c._version = "loading...(JS " + c._jsVersion + "." + c._jsEditVersion + ")"),
                (c._productKeys = (!l && "t0076xQAAAIoSkd9hSgLZuTmzqSGw5WrYJcRwOxQXSHzNLRTFZ/Cb6juBjBKUPL7lsOMjZuF33XlJ/V4rf58yYff9XGfQWMZ2uuUECFEpZw==") || ""),
                (c.browserInfo = (function () {
                    if (l) {
                        const e = n(5);
                        return { browser: "node", version: process.version.substring(1), OS: e.platform() + e.release() };
                    }
                    var e = {
                        init: function () {
                    ...
                    return e.init(), { browser: e.browser, version: e.version, OS: e.OS };
                })()),
                (c._workerName = "dbr-" + c._jsVersion + ".worker.js"),
                (c._bUseIndexDB = !0),
                (c._engineResourcePath = (() => {
                ...
                (c._licenseServer = []),
                (c._deviceFriendlyName = ""),
                (c._isShowRelDecodeTimeInResults = !1),
                (c._bWasmDebug = !1),
                (c._bSendSmallRecordsForDebug = !1),
                (c.__bUseFullFeature = l),
                (c._nextTaskID = 0),
                (c._taskCallbackMap = new Map()),
                (c._loadWasmStatus = "unload"),
                (c._loadWasmCallbackArr = []),
                (c._lastErrorCode = 0),
                (c._lastErrorString = "");
            ...
            class h extends c {
                constructor() {
                    super(),
                        (this.styleEls = []),
                        (this.videoSettings = { video: { width: { ideal: 1280 }, height: { ideal: 720 }, facingMode: { ideal: "environment" } } }),
                        (this._singleFrameMode = !(navigator && navigator.mediaDevices && navigator.mediaDevices.getUserMedia)),
                        (this._singleFrameModeIpt = (() => {
                        ...
                        (this._intervalDetectVideoPause = 1e3),
                        (this._video = null),
                        ...
                        (this._btnClose = null),
                        (this._soundOnSuccessfullRead = new Audio(
                        ...
                        (this.barcodeFillStyle = "rgba(254,180,32,0.3)"),
                        (this.barcodeStrokeStyle = "rgba(254,180,32,0.9)"),
                        (this.barcodeLineWidth = 1),
                        (this.beingLazyDrawRegionsults = !1),
                        (this._indexVideoRegion = -1),
                        (this._onCameraSelChange = () => {
                            this.play(this._selCam.value)
                                .then(() => {
                ...
                set region(e) {
                    (this._region = e),
                        this.singleFrameMode ||
                            ((this.beingLazyDrawRegionsults = !0),
                            setTimeout(() => {
                    ...
                    return u(this, void 0, void 0, function* () {
                        return yield new Promise((e, t) => {
                            ...
                            c._taskCallbackMap.set(n, (n) => {
                                ...
                                c._dbrWorker.postMessage({ type: "clearMapDecodeRecord", id: n, instanceID: this._instanceID });
                        });
                    });
                }
                updateRuntimeSettings(e) {
                    return u(this, void 0, void 0, function* () {
                        ...
                        if ("string" == typeof e || ("object" == typeof e && e instanceof String))
                            if ("speed" == e) {
                                ...
                                yield this.resetRuntimeSettings(),
                                    ...
                                    (t.region = [
                                        null,
                                        { regionLeft: 0, regionTop: 30, regionRight: 100, regionBottom: 70, regionMeasuredByPercentage: 1 },
                                        { regionLeft: 25, regionTop: 25, regionRight: 75, regionBottom: 75, regionMeasuredByPercentage: 1 },
                                        { regionLeft: 25, regionTop: 25, regionRight: 75, regionBottom: 75, regionMeasuredByPercentage: 1 },
                                    ]),
                            ...
                            if (((t = JSON.parse(JSON.stringify(e))), t.region instanceof Array)) {
                                let n = e.region;
                                [n.regionLeft, n.regionTop, n.regionLeft, n.regionBottom, n.regionMeasuredByPercentage].some((e) => void 0 !== e) &&
                                    (t.region = {
                            ...
                            if (((this.userDefinedRegion = JSON.parse(JSON.stringify(e))), e instanceof Array))
                                if (e.length) {
                                    for (let t = 0; t < e.length; ++t) {
                                        let n = e[t];
                                        n &&
                                            (((n.regionLeft || n.regionTop || n.regionRight || n.regionBottom || n.regionMeasuredByPercentage) &&
                        ...
                        yield new Promise((e, n) => {
                            ...
                            "single" == e &&
                                (yield this.setModeArgument("BinarizationModes", 0, "EnableFillBinaryVacancy", "0"),
                                yield this.setModeArgument("LocalizationModes", 0, "ScanDirection", "2"),
                                yield this.setModeArgument("BinarizationModes", 0, "BlockSizeX", "71"),
                                yield this.setModeArgument("BinarizationModes", 0, "BlockSizeY", "71"));
                    });
                }
                _bindUI() {
                    ...
                    for (let t = 0; t < e.length; ++t) for (let n of e[t].children) e.push(n);
                    let n = null;
                    for (let t of e)
                        !this._video && t.classList.contains("dbrScanner-video")
                            ? ((this._video = t), this._video.setAttribute("playsinline", "true"))
                            : !this._cvsDrawArea && t.classList.contains("dbrScanner-cvs-drawarea")
                            ? (this._cvsDrawArea = t)
                            : !this._divScanArea && t.classList.contains("dbrScanner-cvs-scanarea")
                            ? (this._divScanArea = t)
                            : !this._divScanLight && t.classList.contains("dbrScanner-scanlight")
                            ? (this._divScanLight = t)
                            : !this._bgLoading && t.classList.contains("dbrScanner-bg-loading")
                            ? (this._bgLoading = t)
                            : !this._bgCamera && t.classList.contains("dbrScanner-bg-camera")
                            ? (this._bgCamera = t)
                            : !this._selCam && t.classList.contains("dbrScanner-sel-camera")
                            ? (this._selCam = t)
                            : !this._selRsl && t.classList.contains("dbrScanner-sel-resolution")
                            ? ((this._selRsl = t),
                              this._selRsl.options.length ||
                            ...
                            : !this._optGotRsl && t.classList.contains("dbrScanner-opt-gotResolution")
                            ? (this._optGotRsl = t)
                            : !this._btnClose && t.classList.contains("dbrScanner-btn-close")
                            ? (this._btnClose = t)
                            : !this._video && t.classList.contains("dbrScanner-existingVideo")
                            ? ((this._video = t), this._video.setAttribute("playsinline", "true"), (this.singleFrameMode = !1))
                            : !n && t.tagName && "video" == t.tagName.toLowerCase() && (n = t);
                    if (
                        (!this._video && n && (this._video = n),
                        this.singleFrameMode
                            ? (this._video && (this._video.addEventListener("click", this._clickIptSingleFrameMode), (this._video.style.cursor = "pointer"), this._video.setAttribute("title", "Take a photo")),
                              this._cvsDrawArea && (this._cvsDrawArea.addEventListener("click", this._clickIptSingleFrameMode), (this._cvsDrawArea.style.cursor = "pointer"), this._cvsDrawArea.setAttribute("title", "Take a photo")),
                              this._divScanArea && (this._divScanArea.addEventListener("click", this._clickIptSingleFrameMode), (this._divScanArea.style.cursor = "pointer"), this._divScanArea.setAttribute("title", "Take a photo")),
                              this._bgCamera && (this._bgCamera.style.display = ""))
                            : this._bgLoading && (this._bgLoading.style.display = ""),
                        this._selCam && this._selCam.addEventListener("change", this._onCameraSelChange),
                        this._selRsl && this._selRsl.addEventListener("change", this._onResolutionSelChange),
                ...
                _unbindUI() {
                    this._clearRegionsults(),
                        this.singleFrameMode
                            ? (this._video && (this._video.removeEventListener("click", this._clickIptSingleFrameMode), (this._video.style.cursor = ""), this._video.removeAttribute("title")),
                              this._cvsDrawArea && (this._cvsDrawArea.removeEventListener("click", this._clickIptSingleFrameMode), (this._cvsDrawArea.style.cursor = ""), this._cvsDrawArea.removeAttribute("title")),
                              this._divScanArea && (this._divScanArea.removeEventListener("click", this._clickIptSingleFrameMode), (this._divScanArea.style.cursor = ""), this._divScanArea.removeAttribute("title")),
                              this._bgCamera && (this._bgCamera.style.display = "none"))
                    ...
                    return u(this, void 0, void 0, function* () {
                        return yield new Promise((e, t) => {
                            ...
                            c._taskCallbackMap.set(n, (n) => {
                                ...
                                c._dbrWorker.postMessage({ type: "getScanSettings", id: n, instanceID: this._instanceID });
                        });
                    });
                }
                        ...
                        return (
                            ...
                            yield new Promise((t, n) => {
                                ...
                                c._taskCallbackMap.set(r, (e) => {
                                    ...
                                    h._dbrWorker.postMessage({ type: "updateScanSettings", id: r, instanceID: this._instanceID, body: { settings: e } });
                            })
                        );
                    });
                }
                ...
                _show() {
                    this.UIElement.parentNode || ((this.UIElement.style.position = "fixed"), (this.UIElement.style.left = "0"), (this.UIElement.style.top = "0"), document.body.append(this.UIElement)),
                        "none" == this.UIElement.style.display && (this.UIElement.style.display = "");
                }
                stop() {
                    this._video &&
                        this._video.srcObject &&
                        (c._onLog && c._onLog("======stop video========"),
                        this._video.srcObject.getTracks().forEach((e) => {
                            e.stop();
                        }),
                        (this._video.srcObject = null),
                        (this._videoTrack = null)),
                        this._video && this._video.classList.contains("dbrScanner-existingVideo") && (c._onLog && c._onLog("======stop existing video========"), this._video.pause(), (this._video.currentTime = 0)),
                ...
                play(e, t, n) {
                    return u(this, void 0, void 0, function* () {
                        if ((this._assertOpen(), this.singleFrameMode)) return this._clickIptSingleFrameMode(), { width: 0, height: 0 };
                        ...
                        if (
                            (i
                                ? t >= 1280 || n >= 1280
                                    ...
                                    : t >= 640 || n >= 640
                                    ? (r.video.width = 640)
                                    : (t < 640 || n < 640) && (r.video.width = 320)
                                : (t && (r.video.width = { ideal: t }), n && (r.video.height = { ideal: n })),
                            e)
                        )
                            delete r.video.facingMode, (r.video.deviceId = { exact: e }), (this._lastDeviceId = e);
                        else if (r.video.deviceId);
                        else if (this._lastDeviceId) delete r.video.facingMode, (r.video.deviceId = { ideal: this._lastDeviceId });
                            ...
                            if ((e instanceof Array && e.length && (e = e[0]), (e = e.exact || e.ideal || e), "environment" === e)) {
                                for (let e of this._allCameras) {
                                    ...
                                    if (t && -1 != t.indexOf("facing back") && /camera[0-9]?\s0,/.test(t)) {
                                        delete r.video.facingMode, (r.video.deviceId = { ideal: e.deviceId });
                                        break;
                                    }
                                }
                        ...
                        try {
                            ...
                            c._onLog && c._onLog(e),
                                ...
                                i
                                    ? (delete r.video.width, delete r.video.height)
                                    : o
                                    ? (delete r.video.facingMode, this._allCameras.length && (r.video.deviceId = { ideal: this._allCameras[this._allCameras.length - 1].deviceId }))
                                    : (r.video = !0),
                                c._onLog && c._onLog(r),
                                (s = yield navigator.mediaDevices.getUserMedia(r));
                        }
                        {
                        ...
                        this._optGotRsl &&
                            ...
                            (this._optGotRsl.innerText = a),
                            this._selRsl && this._optGotRsl.parentNode == this._selRsl && (this._selRsl.value = "got")),
                            c._onLog && c._onLog(a),
                            yield this.getCurrentCamera(),
                            this._renderSelCameraInfo();
                        let d = { width: this._video.videoWidth, height: this._video.videoHeight };
                        return (
                            this.onPlayed &&
                                setTimeout(() => {
                                    this.onPlayed(d);
                ...
                turnOnTorch() {
                    return u(this, void 0, void 0, function* () {
                        if ((this._assertOpen(), this.getCapabilities().torch)) return yield this._videoTrack.applyConstraints({ advanced: [{ torch: !0 }] });
                        throw Error("Not support.");
                    });
                }
                turnOffTorch() {
                    return u(this, void 0, void 0, function* () {
                        if ((this._assertOpen(), this.getCapabilities().torch)) return yield this._videoTrack.applyConstraints({ advanced: [{ torch: !1 }] });
                        throw Error("Not support.");
                    });
                }
                setColorTemperature(e) {
                    return u(this, void 0, void 0, function* () {
                        ...
                        return e < t.min ? (e = t.min) : e > t.max && (e = t.max), yield this._videoTrack.applyConstraints({ advanced: [{ colorTemperature: e }] });
                    });
                }
                setExposureCompensation(e) {
                    return u(this, void 0, void 0, function* () {
                        ...
                        if (!t) throw Error("Not support.");
                        return e < t.min ? (e = t.min) : e > t.max && (e = t.max), yield this._videoTrack.applyConstraints({ advanced: [{ exposureCompensation: e }] });
                    });
                }
                setZoom(e) {
                    return u(this, void 0, void 0, function* () {
                        ...
                        if (!t) throw Error("Not support.");
                        return e < t.min ? (e = t.min) : e > t.max && (e = t.max), yield this._videoTrack.applyConstraints({ advanced: [{ zoom: e }] });
                    });
                }
                setFrameRate(e) {
                    return u(this, void 0, void 0, function* () {
                        ...
                        if (!t) throw Error("Not support.");
                        return e < t.min ? (e = t.min) : e > t.max && (e = t.max), yield this._videoTrack.applyConstraints({ width: { ideal: Math.max(this._video.videoWidth, this._video.videoHeight) }, frameRate: e });
                    });
                }
                ...
                _loopReadVideo() {
                    return u(this, void 0, void 0, function* () {
                        ...
                        this._decode_Video(this._video, e)
                            .then((e) => {
                                if ((c._onLog && c._onLog(e), this._isOpen && !this._video.paused && !this._bPauseScan)) {
                                    if (this.bPlaySoundOnSuccessfulRead && e.length) {
                                        ...
                                        t && ((this.soundOnSuccessfullRead.currentTime = 0), this.soundOnSuccessfullRead.play());
                                    }
                                    if (this.onFrameRead) {
                                    ...
                                    if (this.onUnduplicatedRead) for (let t of e) t.bUnduplicated && this.onUnduplicatedRead(t.barcodeText, this._cloneDecodeResults(t));
                            ...
                            .catch((e) => {
                                if (
                                    (c._onLog && c._onLog(e.message || e),
                                    setTimeout(() => {
                                        this._loopReadVideo();
                                    }, Math.max(this.intervalTime, 1e3)),
                ...
                _drawRegionsults(e) {
                    ...
                    if (
                        (i &&
                            ((!i.regionLeft && !i.regionRight && !i.regionTop && !i.regionBottom && !i.regionMeasuredByPercentage) || i instanceof Array
                                ? (i = null)
                                : i.regionMeasuredByPercentage
                                ? (i =
                                      i.regionLeft || i.regionRight || 100 !== i.regionTop || 100 !== i.regionBottom
                                          ? {
                                          ...
                                          : null)
                                : ((i = JSON.parse(JSON.stringify(i))), delete i.regionMeasuredByPercentage)),
                        this._cvsDrawArea)
                    ) {
                        ...
                        if (i) {
                            ...
                            s.fillRect(i.regionLeft - e, i.regionTop - e, i.regionRight - i.regionLeft + 2 * e, i.regionBottom - i.regionTop + 2 * e),
                                (s.globalCompositeOperation = "source-over"),
                                (s.strokeStyle = this.regionMaskStrokeStyle),
                                (s.lineWidth = this.regionMaskLineWidth),
                                s.rect(i.regionLeft, i.regionTop, i.regionRight - i.regionLeft, i.regionBottom - i.regionTop),
                                s.stroke();
                        }
                        if (e) {
                    ...
                    if (this._divScanArea) {
                        let e = this._video.offsetWidth,
                            ...
                            o = 1;
                        e / t < n / r
                            ? ((o = e / n), (this._divScanArea.style.left = "0"), (this._divScanArea.style.top = Math.round((t - r * o) / 2) + "px"))
                            : ((o = t / r), (this._divScanArea.style.left = Math.round((e - n * o) / 2) + "px"), (this._divScanArea.style.top = "0"));
                ...
                destroy() {
                    const e = Object.create(null, { destroy: { get: () => super.destroy } });
                    return u(this, void 0, void 0, function* () {
                        this.close();
            ...
            var f, g, E, R, I, v, A, m, y, p, S, T, D, b, M, C, O, N, L, B, w, P, F, k, U, V, x, G;
            !(function (e) {
                (e[(e.BICM_DARK_ON_LIGHT = 1)] = "BICM_DARK_ON_LIGHT"),
                    (e[(e.BICM_LIGHT_ON_DARK = 2)] = "BICM_LIGHT_ON_DARK"),
                    (e[(e.BICM_DARK_ON_DARK = 4)] = "BICM_DARK_ON_DARK"),
                    (e[(e.BICM_LIGHT_ON_LIGHT = 8)] = "BICM_LIGHT_ON_LIGHT"),
                    (e[(e.BICM_DARK_LIGHT_MIXED = 16)] = "BICM_DARK_LIGHT_MIXED"),
                    (e[(e.BICM_DARK_ON_LIGHT_DARK_SURROUNDING = 32)] = "BICM_DARK_ON_LIGHT_DARK_SURROUNDING"),
                    (e[(e.BICM_SKIP = 0)] = "BICM_SKIP"),
                    (e[(e.BICM_REV = 2147483648)] = "BICM_REV");
            })(f || (f = {})),
                (function (e) {
                    (e[(e.BCM_AUTO = 1)] = "BCM_AUTO"), (e[(e.BCM_GENERAL = 2)] = "BCM_GENERAL"), (e[(e.BCM_SKIP = 0)] = "BCM_SKIP"), (e[(e.BCM_REV = 2147483648)] = "BCM_REV");
                })(g || (g = {})),
                (function (e) {
                    (e[(e.BF2_NULL = 0)] = "BF2_NULL"),
                        (e[(e.BF2_POSTALCODE = 32505856)] = "BF2_POSTALCODE"),
                        (e[(e.BF2_NONSTANDARD_BARCODE = 1)] = "BF2_NONSTANDARD_BARCODE"),
                        (e[(e.BF2_USPSINTELLIGENTMAIL = 1048576)] = "BF2_USPSINTELLIGENTMAIL"),
                        (e[(e.BF2_POSTNET = 2097152)] = "BF2_POSTNET"),
                        (e[(e.BF2_PLANET = 4194304)] = "BF2_PLANET"),
                        (e[(e.BF2_AUSTRALIANPOST = 8388608)] = "BF2_AUSTRALIANPOST"),
                        (e[(e.BF2_RM4SCC = 16777216)] = "BF2_RM4SCC"),
                        (e[(e.BF2_DOTCODE = 2)] = "BF2_DOTCODE");
                })(E || (E = {})),
                (function (e) {
                ...
                (function (e) {
                    (e[(e.DM_SKIP = 0)] = "DM_SKIP"),
                        (e[(e.DM_DIRECT_BINARIZATION = 1)] = "DM_DIRECT_BINARIZATION"),
                        (e[(e.DM_THRESHOLD_BINARIZATION = 2)] = "DM_THRESHOLD_BINARIZATION"),
                        (e[(e.DM_GRAY_EQUALIZATION = 4)] = "DM_GRAY_EQUALIZATION"),
                        (e[(e.DM_SMOOTHING = 8)] = "DM_SMOOTHING"),
                        (e[(e.DM_MORPHING = 16)] = "DM_MORPHING"),
                        (e[(e.DM_DEEP_ANALYSIS = 32)] = "DM_DEEP_ANALYSIS"),
                        (e[(e.DM_SHARPENING = 64)] = "DM_SHARPENING");
                })(p || (p = {})),
                (function (e) {
                ...
                (function (e) {
                    (e[(e.IPM_AUTO = 1)] = "IPM_AUTO"),
                        (e[(e.IPM_GENERAL = 2)] = "IPM_GENERAL"),
                        (e[(e.IPM_GRAY_EQUALIZE = 4)] = "IPM_GRAY_EQUALIZE"),
                        (e[(e.IPM_GRAY_SMOOTH = 8)] = "IPM_GRAY_SMOOTH"),
                        (e[(e.IPM_SHARPEN_SMOOTH = 16)] = "IPM_SHARPEN_SMOOTH"),
                        (e[(e.IPM_MORPHOLOGY = 32)] = "IPM_MORPHOLOGY"),
                        (e[(e.IPM_SKIP = 0)] = "IPM_SKIP"),
                        (e[(e.IPM_REV = 2147483648)] = "IPM_REV");
                })(b || (b = {})),
                (function (e) {
                    (e[(e.IRSM_MEMORY = 1)] = "IRSM_MEMORY"), (e[(e.IRSM_FILESYSTEM = 2)] = "IRSM_FILESYSTEM"), (e[(e.IRSM_BOTH = 4)] = "IRSM_BOTH");
                })(M || (M = {})),
                (function (e) {
                    (e[(e.IRT_NO_RESULT = 0)] = "IRT_NO_RESULT"),
                        (e[(e.IRT_ORIGINAL_IMAGE = 1)] = "IRT_ORIGINAL_IMAGE"),
                        (e[(e.IRT_COLOUR_CLUSTERED_IMAGE = 2)] = "IRT_COLOUR_CLUSTERED_IMAGE"),
                        (e[(e.IRT_COLOUR_CONVERTED_GRAYSCALE_IMAGE = 4)] = "IRT_COLOUR_CONVERTED_GRAYSCALE_IMAGE"),
                        (e[(e.IRT_TRANSFORMED_GRAYSCALE_IMAGE = 8)] = "IRT_TRANSFORMED_GRAYSCALE_IMAGE"),
                        (e[(e.IRT_PREDETECTED_REGION = 16)] = "IRT_PREDETECTED_REGION"),
                        (e[(e.IRT_PREPROCESSED_IMAGE = 32)] = "IRT_PREPROCESSED_IMAGE"),
                        (e[(e.IRT_BINARIZED_IMAGE = 64)] = "IRT_BINARIZED_IMAGE"),
                        (e[(e.IRT_TEXT_ZONE = 128)] = "IRT_TEXT_ZONE"),
                        (e[(e.IRT_CONTOUR = 256)] = "IRT_CONTOUR"),
                        (e[(e.IRT_LINE_SEGMENT = 512)] = "IRT_LINE_SEGMENT"),
                        (e[(e.IRT_FORM = 1024)] = "IRT_FORM"),
                        (e[(e.IRT_SEGMENTATION_BLOCK = 2048)] = "IRT_SEGMENTATION_BLOCK"),
                        (e[(e.IRT_TYPED_BARCODE_ZONE = 4096)] = "IRT_TYPED_BARCODE_ZONE"),
                        (e[(e.IRT_PREDETECTED_QUADRILATERAL = 8192)] = "IRT_PREDETECTED_QUADRILATERAL");
                })(C || (C = {})),
                (function (e) {
                    (e[(e.LM_SKIP = 0)] = "LM_SKIP"),
                        (e[(e.LM_AUTO = 1)] = "LM_AUTO"),
                        (e[(e.LM_CONNECTED_BLOCKS = 2)] = "LM_CONNECTED_BLOCKS"),
                        (e[(e.LM_LINES = 8)] = "LM_LINES"),
                        (e[(e.LM_STATISTICS = 4)] = "LM_STATISTICS"),
                        (e[(e.LM_SCAN_DIRECTLY = 16)] = "LM_SCAN_DIRECTLY"),
                        (e[(e.LM_STATISTICS_MARKS = 32)] = "LM_STATISTICS_MARKS"),
                        (e[(e.LM_STATISTICS_POSTAL_CODE = 64)] = "LM_STATISTICS_POSTAL_CODE"),
                        (e[(e.LM_CENTRE = 128)] = "LM_CENTRE"),
                        (e[(e.LM_REV = 2147483648)] = "LM_REV");
                })(O || (O = {})),
                (function (e) {
                ...
                (function (e) {
                    (e[(e.QRECL_ERROR_CORRECTION_H = 0)] = "QRECL_ERROR_CORRECTION_H"),
                        (e[(e.QRECL_ERROR_CORRECTION_L = 1)] = "QRECL_ERROR_CORRECTION_L"),
                        (e[(e.QRECL_ERROR_CORRECTION_M = 2)] = "QRECL_ERROR_CORRECTION_M"),
                        (e[(e.QRECL_ERROR_CORRECTION_Q = 3)] = "QRECL_ERROR_CORRECTION_Q");
                })(L || (L = {})),
                (function (e) {
                    (e[(e.RPM_AUTO = 1)] = "RPM_AUTO"),
                        (e[(e.RPM_GENERAL = 2)] = "RPM_GENERAL"),
                        (e[(e.RPM_GENERAL_RGB_CONTRAST = 4)] = "RPM_GENERAL_RGB_CONTRAST"),
                        (e[(e.RPM_GENERAL_GRAY_CONTRAST = 8)] = "RPM_GENERAL_GRAY_CONTRAST"),
                        (e[(e.RPM_GENERAL_HSV_CONTRAST = 16)] = "RPM_GENERAL_HSV_CONTRAST"),
                        (e[(e.RPM_SKIP = 0)] = "RPM_SKIP"),
                        (e[(e.RPM_REV = 2147483648)] = "RPM_REV");
                })(B || (B = {})),
                (function (e) {
                ...
                (function (e) {
                    (e[(e.SUM_AUTO = 1)] = "SUM_AUTO"),
                        (e[(e.SUM_LINEAR_INTERPOLATION = 2)] = "SUM_LINEAR_INTERPOLATION"),
                        (e[(e.SUM_NEAREST_NEIGHBOUR_INTERPOLATION = 4)] = "SUM_NEAREST_NEIGHBOUR_INTERPOLATION"),
                        (e[(e.SUM_SKIP = 0)] = "SUM_SKIP"),
                        (e[(e.SUM_REV = 2147483648)] = "SUM_REV");
                })(F || (F = {})),
                (function (e) {
                    (e[(e.TP_REGION_PREDETECTED = 1)] = "TP_REGION_PREDETECTED"),
                        (e[(e.TP_IMAGE_PREPROCESSED = 2)] = "TP_IMAGE_PREPROCESSED"),
                        (e[(e.TP_IMAGE_BINARIZED = 4)] = "TP_IMAGE_BINARIZED"),
                        (e[(e.TP_BARCODE_LOCALIZED = 8)] = "TP_BARCODE_LOCALIZED"),
                        (e[(e.TP_BARCODE_TYPE_DETERMINED = 16)] = "TP_BARCODE_TYPE_DETERMINED"),
                        (e[(e.TP_BARCODE_RECOGNIZED = 32)] = "TP_BARCODE_RECOGNIZED");
                })(k || (k = {})),
                (function (e) {
                    (e[(e.TACM_AUTO = 1)] = "TACM_AUTO"),
                        (e[(e.TACM_VERIFYING = 2)] = "TACM_VERIFYING"),
                        (e[(e.TACM_VERIFYING_PATCHING = 4)] = "TACM_VERIFYING_PATCHING"),
                        (e[(e.TACM_SKIP = 0)] = "TACM_SKIP"),
                        (e[(e.TACM_REV = 2147483648)] = "TACM_REV");
                })(U || (U = {})),
                (function (e) {
            ...
            const W = {
                ...
                EnumDPMCodeReadingMode: T,
                EnumErrorCode: i,
                EnumGrayscaleTransformationMode: D,
                ...
                EnumPDFReadingMode: N,
                EnumQRCodeErrorCorrectionLevel: L,
                EnumRegionPredetectionMode: B,
                EnumResultCoordinateType: w,
                EnumResultType: P,
                EnumScaleUpMode: F,
                EnumTerminatePhase: k,
                EnumTextAssistedCorrectionMode: U,
                EnumTextFilterMode: V,
                EnumTextResultOrderMode: x,
